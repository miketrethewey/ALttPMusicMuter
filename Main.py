...
#Usage: python Main.py --rom lttpromtobepatched.sfc #generates lttpromtobepatched_musicless.sfc
...
if __name__ == '__main__':
    ...
    parser.add_argument('--music',	default='off',	const='info',	nargs='?',	choices=['off','on'],	help='Music Off/On')
